...
public class PrimeNumberCalculatorMain : Form
{
    ...
    private ColumnHeader taskIdColHeader;
    private ColumnHeader progressColHeader;
    private ColumnHeader currentColHeader;
    private Panel buttonPanel;
    private Panel panel2;
    private Button startAsyncButton;
    private Button cancelButton;
    private ColumnHeader testNumberColHeader;
    private ColumnHeader resultColHeader;
    private ColumnHeader firstDivisorColHeader;
    ...
    private void InitializeComponent()
    {
        ...
        this.taskGroupBox = new GroupBox();
        this.buttonPanel = new Panel();
        this.cancelButton = new Button();
        this.startAsyncButton = new Button();
        this.listView1 = new ListView();
        this.testNumberColHeader = new ColumnHeader();
        this.progressColHeader = new ColumnHeader();
        this.currentColHeader = new ColumnHeader();
        this.taskIdColHeader = new ColumnHeader();
        this.resultColHeader = new ColumnHeader();
        this.firstDivisorColHeader = new ColumnHeader();
        ...
        this.taskGroupBox.Dock = DockStyle.Fill;
