    ...
    internal class Program
    {
        ...
        static bool Login(User user)
        {
            ...
            try
            {
                ...
                if (resOP1.IsValid == false || ResultPasswordTest(user.Password!) == false) throw new WrongPasswordException("Invalid password.Please check your password");
                if (resOP2.IsValid == false) throw new WrongLoginException("Invalid login.Please check your login");
            }
